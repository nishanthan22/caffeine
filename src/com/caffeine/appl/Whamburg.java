...
public class Whamburg {
	public static void main(String[] args) {
		...
		String txtFilePath = Utilities.getFilePath(Constants.FILE_NAME_PATH_PREFIX, "Whamburg.txt");
		String csvFilePath = Utilities.getFilePath(Constants.FILE_NAME_PATH_PREFIX, "Whamburg.csv");
...
//			Map<String, String> dataMap = new HashMap<>();
			...
			for (int i = 0; i < firstDiv.size(); i++) {
                ...
                .append(Constants.PRICE).append(priceText).append("\n")
...
//
			...
			for (int i = 0; i < bsFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(bsPriceText).append("\n")
			...
			for (int i = 0; i < friesFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(friesPriceText).append("\n")
                .append(Constants.DESCRIPTION).append(friesDescText).append("\n")
                .append("----------\n");
			...
			for (int i = 0; i < dessertFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(dessertPriceText).append("\n")
                .append(Constants.DESCRIPTION).append(dessertDescText).append("\n")
                .append("----------\n");
			}
...
//				String descriptionCSV = beveragesDescText.replace(",", ";");
                ...
                .append(Constants.PRICE).append(beveragesPriceText).append("\n")
                .append(Constants.DESCRIPTION).append(beveragesDescText).append("\n")
                .append("----------\n");
			}
			...
			for (int i = 0; i < shakesFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(shakesPriceText).append("\n")
                .append(Constants.DESCRIPTION).append(shakesDescText).append("\n")
                .append("----------\n");
			...
			for (int i = 0; i < sidesFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(sidesPriceText).append("\n")
                .append("----------\n");
			}
			...
			for (int i = 0; i < beerFirst.size(); i++) {
                ...
                .append(Constants.PRICE).append(beerPriceText).append("\n")
                .append("----------\n");
			}
