...
public class AutoCity {
	public static void main(String[] args) {
		...
		String txtFilePath = Utilities.getFilePath(Constants.FILE_NAME_PATH_PREFIX, "AutoCity.txt");
		String csvFilePath = Utilities.getFilePath(Constants.FILE_NAME_PATH_PREFIX, "AutoCity.csv");
		   ...
		   consoleOutput.append("\n---------\n Original Menu \n----------\n");
            ...
            for (WebElement product : productList) {
               ...
               csvOutput.append(String.format("%s,%s,%s\n", title, price, descriptionCSV));
                ...
                .append(Constants.PRICE).append(price).append("\n")
